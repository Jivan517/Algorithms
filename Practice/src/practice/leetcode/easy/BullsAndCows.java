 ...
 * you provide a hint that indicates how many digits in said guess match your secret number exactly in both digit and position (called "bulls") and how many digits match the secret 
 * number but locate in the 
 * wrong position (called "cows"). 
...
public class BullsAndCows {
	...
	public static void main(String[] args) {
		...
		System.out.println("Hit For Secret number:  '1123' Friend's guess: '0111' - " + getHint("1123", "0111") );
